...
<html class="" lang="spanish">
	  <head>
	    ...
	    <title>Modificar contacto - SmartAgenda</title>
	  ...
	  <body>
		...
		?>
		    <div class="holi" style=" max-width:255px; float:left;">
		    	<div>
		    		<img src="../<?php echo $datos->imagen; ?>" style="padding:10px; width:250px; ">
		    	</div>
		    	<div style="text-align:center; background:yelow; color:white;">
		    		<?php echo $datos->nombre; ?>
		    	</div>
		    	<form method="POST" action="<?php echo site_url('contactos/modificar/.'); ?>">
		    	<div style="text-align:center; padding:10px;">
		    		<input type="text" hidden="true" name="id" value="<?php echo $datos->id_contacto; ?>">
		    		<input type="submit" value="Modificar" style="width:230px;" class="btn btn-success">
		    	</div>
		    	</form>
		    </div>
		<?php
