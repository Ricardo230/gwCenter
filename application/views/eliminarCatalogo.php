...
<html class="" lang="spanish">
	  <head>
	    ...
	    <title>Eliminar contacto - SmartAgenda</title>
	  ...
	  <body>
		...
		<!--Aqui van los divs-->
		<div class="container" style="background:ray; width:100%;">
		<?php
			$i = 0;
	      	foreach ($data as $datos) {
		?>
		    <div class="holi" style=" max-width:255px; float:left;">
		    	<div>
		    		<img src="<?php echo base_url(); echo $datos->imagen; ?>" style="padding:10px; width:250px; ">
		    	</div>
		    	<div style="text-align:center; background:yelow; color:white;">
		    		<?php echo $datos->nombre; ?>
		    	</div>
		    	<form method="POST" action="<?php echo site_url('contactos/eliminar/.'); ?>">
		    	<div style="text-align:center; padding:10px;">
		    		<input type="text" hidden="true" name="id" value="<?php echo $datos->id_contacto; ?>">
		    		<input type="submit" value="Eliminar" style="width:230px;" name="button" class="btn btn-danger">
		    	</div>
		    	</form>
		    </div>
		<?php
